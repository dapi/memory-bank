...
- [`template/memory-bank/flows/feature.md`](template/memory-bank/flows/feature.md) зависит от governance, frontmatter и [`template/memory-bank/flows/routing.md`](template/memory-bank/flows/routing.md).
