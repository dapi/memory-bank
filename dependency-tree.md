...
- [`template/memory-bank/engineering/testing-conventions.md`](template/memory-bank/engineering/testing-conventions.md) зависит от [`template/memory-bank/dna/governance.md`](template/memory-bank/dna/governance.md) и [`template/memory-bank/flows/testing-policy.md`](template/memory-bank/flows/testing-policy.md); project-specific стек исполняет generic policy и не может её ослаблять.
