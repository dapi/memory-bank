# «Бесконечная» сессия AI-агента: цифровые роли и долговечное состояние задачи

Отправной точкой для статьи стал созвон Михаила С. «Управление сложностью кода через Code Property Graph и цифровые роли»:

<https://app.mymeet.ai/ru/public-meetings/ab134fa3-e164-4e5a-89f0-c8530cfde37d>

На встрече обсуждалась система оркестрации вокруг цифровых ролей, декларативного workflow и Temporal. Разделы о применении этой модели к Memory Bank — моя интерпретация и проектное предложение, а не дословный пересказ Михаила.
...
Workflow — это state machine. Насколько я понял из обсуждения, в показанной Михаилом реализации оркестрация построена вокруг Temporal, а workflow описывается декларативно в YAML. Это позволяет менять порядок и состав ролей без переписывания всей бизнес-логики оркестратора.
...
## Моя интерпретация для Memory Bank
...
Такое внедрение в Memory Bank стоит считать завершённым, когда:
