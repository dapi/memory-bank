...
- `../../../adr/ADR-XXX-short-decision-name.md`
  Читать, когда нужно: если по фиче существует связанный ADR, оформить или проверить его с `status: active` и корректным `decision_status`.
