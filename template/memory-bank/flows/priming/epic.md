---
title: P1-EPIC Context Priming
doc_kind: governance
doc_function: canonical
purpose: Route-specific праймеринг перед Epic Intake или Bootstrap Epic.
derived_from:
  - context-priming.md
  - ../epic.md
canonical_for:
  - p1_epic_priming
  - epic_priming_input_classes
status: active
...
delivery feature packages, roadmap waves или code-level plan до Epic gates.
