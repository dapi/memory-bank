...
- [UI Design Guide](ui-design-guide/README.md) — optional companion по содержанию для проектов с существующим UI kit: components, forms, actions, tables, navigation, states, screenshots, source paths и agent instructions.
