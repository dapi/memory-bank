...
grounded SHA, перед execution получен clean Plan Ready verdict. При переносе
на другую revision сначала повторить grounding.
...
| STEP-03 | Автор: structural checks, simplify pass и независимая document review | CHK-01–02 / EVID-01–02 | STEP-02 |
...
candidate и structured verdict фиксируются вне reviewed revision.
...
Evidence: `~/.cache/memory-bank-dna-trust/` (EVID-01–02 из brief); итоговый
