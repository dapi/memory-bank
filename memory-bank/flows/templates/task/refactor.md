...
Promotion check: если меняется observable behavior, contract, rollout, security/financial boundary или несколько bounded contexts, повторить routing по `flows/routing.md`.
