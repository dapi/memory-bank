...
Decision log не заменяет [routing.md](routing.md): canonical routing rules остаются там. Здесь живет причинно-следственная запись: почему selector менялся, какие риски учитывались, как решение будет пересмотрено и какими evidence оно должно подтверждаться.
