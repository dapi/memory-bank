...
| [Code Property Graph](articles/code-property-graph.md) | Как AST, CFG, графы вызовов, потоков данных и зависимостей образуют единую модель кода для анализа и AI-агентов |
