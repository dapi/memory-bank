...
- [MECE principle](https://en.wikipedia.org/wiki/MECE_principle) — источник
  правила для непересекающихся и совместно исчерпывающих закрытых
  классификаций;
- [Markdown Architectural Decision Records (MADR)](https://adr.github.io/madr/) —
  источник структуры и authoring guidance для локального ADR template;
