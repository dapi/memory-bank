...
После внедрения проведите первую задачу по
[инструкции быстрого старта](quick-start.md), затем используйте
[инструкцию по повседневной работе](usage.md): она описывает накопление
проектных знаний, выбор процесса, реализацию и возврат новых решений в
Memory Bank.
