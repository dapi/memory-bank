...
Скрипт — временное решение. Запрос на ограничение области синхронизации силами самого CLI отправлен в [`dapi/memory-bank-cli#60`](https://github.com/dapi/memory-bank-cli/issues/60); когда он будет закрыт, песочница и ручная правка lock здесь станут не нужны.
