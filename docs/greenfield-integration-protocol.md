...
Скопируй generic-шаблон `memory-bank/` из `dapi/memory-bank` в корень текущего GitHub-репозитория и адаптируй его под описанный в репозитории продукт и проект.
