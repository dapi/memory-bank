...
Используйте один из трёх сценариев. GIF показывают сокращённый ввод в терминале,
а команды под ними можно копировать. Ответы агента будут зависеть от задачи и
...
Это основной сценарий. Memory Bank сам определит подходящий процесс и создаст
...
Проведи ревью созданного комплекта документов, исправь замечания
и после прохождения обязательных этапов приступай к реализации.'
```
