...
<p align="center">
  <img src="docs/assets/memory-bank-demo.gif" alt="Memory Bank CLI показывает план установки, добавляет проектный контекст и проверяет его для новой агентной сессии" width="760">
</p>
