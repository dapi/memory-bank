...
`dna/` задаёт правила достоверной документации проекта: владение источниками,
основания утверждений, область применимости, актуальность, метаданные публикации
и навигацию. В `flows/` находятся исполнение задач, полномочия агента и проверки
разработки.

Канонический документ владеет утверждением в объявленном контексте. Производные
требования, планы и представления сохраняют источник и его ограничения.
Публикация со статусом `active` может содержать явно непроверенное предположение;
сам статус не доказывает утверждение.

При расхождении документов сравнивают утверждения, области применимости,
владельцев и смысловые зависимости. Неоднозначное владение остаётся явным
конфликтом до разрешения; более свежая правка не получает автоматический приоритет.
