...
[English version](README.md) · [Внедрение](docs/adoption.md) · [Повседневная работа](docs/usage.md)
...
Бриф → Дизайн-пакет → План реализации
 ...
 Код → проверки → запрос на слияние
          ↓
Решения, подтверждения и новые знания возвращаются в Memory Bank
```
